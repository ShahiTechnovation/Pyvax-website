...
const workflowSteps = [
  {
    ...
    description: "Tell PyVax AI what you want to build in natural language",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-slate-400 max-w-3xl mx-auto">
            Watch how PyVax AI transforms your natural language description into a production-ready dApp
          </p>
        </motion.div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div
                      className={`relative w-12 h-12 rounded-lg flex items-center justify-center ${
                        isActive ? `bg-gradient-to-br ${step.color}` : "bg-slate-700/50"
                      }`}
                    >
