...
export default function ExplorerPage() {
  ...
  const getProvider = () => {
    ...
    return new ethers.JsonRpcProvider(rpcUrls[network] || rpcUrls['fuji'])
  }
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-400 mt-1">
                          This contract hasn't been verified yet. To verify and enable Read/Write functions, deploy again from the PyVax IDE.
                        </p>
                      </div>
                    </div>
                  </Card>
