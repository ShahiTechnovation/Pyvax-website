...
async function generateWithOpenAI(prompt: string, agentId: string, apiKey: string) {
  const systemPrompts = {
    core: `You are an expert Python smart contract developer. Generate clean, secure Python smart contracts using PyVax syntax with @contract, @public, @view decorators. Include comprehensive documentation and follow best practices.`,
...
async function generateWithGemini(prompt: string, agentId: string, apiKey: string) {
  const systemPrompts = {
    core: `You are an expert Python smart contract developer. Generate clean, secure Python smart contracts using PyVax syntax.`,
...
async function generateWithClaude(prompt: string, agentId: string, apiKey: string) {
  const systemPrompts = {
    core: `You are an expert Python smart contract developer. Generate clean, secure Python smart contracts using PyVax syntax with @contract, @public, @view decorators.`,
    ...
    token: `You are a token specialist. Generate ERC20 or ERC721 compliant token contracts in Python using PyVax syntax.`,
