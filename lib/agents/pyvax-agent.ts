 ...
 */
export class PyVaxCoreAgent extends PyVaxAgent {
  constructor() {
    super({
      name: 'PyVax Core',
      description: 'Generate Python smart contracts using PyVax syntax',
 ...
 */
export class PyVaxSecurityAgent extends PyVaxAgent {
  constructor() {
    super({
      name: 'PyVax Security',
...
You identify vulnerabilities and suggest secure implementations using PyVax patterns.`,
      capabilities: [
        'Security auditing',
 ...
 */
export class PyVaxTokenAgent extends PyVaxAgent {
  constructor() {
    super({
      name: 'PyVax Token',
 ...
 */
export class PyVaxDAppAgent extends PyVaxAgent {
  constructor() {
    super({
      name: 'PyVax DApp',
...
You create complete dApps with Python smart contracts and React frontends.`,
  ...
  async generate(prompt: string): Promise<AgentResponse> {
    const contract = new PyVaxCoreAgent()
...
export class AgentManager {
  private agents: Map<string, PyVaxAgent>
  ...
  private registerDefaultAgents() {
    this.registerAgent('core', new PyVaxCoreAgent())
    this.registerAgent('security', new PyVaxSecurityAgent())
    this.registerAgent('token', new PyVaxTokenAgent())
    this.registerAgent('dapp', new PyVaxDAppAgent())
  }

  registerAgent(id: string, agent: PyVaxAgent) {
    this.agents.set(id, agent)
  }

  getAgent(id: string): PyVaxAgent | undefined {
    return this.agents.get(id)
  }

  getAllAgents(): PyVaxAgent[] {
